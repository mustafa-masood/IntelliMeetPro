...
const Calendar: React.FC = () => {
    ...
    return (
        <div className="flex h-dvh max-h-dvh min-h-0 w-full max-w-full im-app-canvas overflow-hidden">
            ...
            <main className="flex-1 flex flex-col min-h-0 h-full overflow-hidden ml-0 md:ml-[270px] transition-all duration-300">
                <div className="bg-bg-surface-alpha-90 backdrop-blur-xl border-b border-stroke-primary h-14 flex items-center px-4 sm:px-7 shrink-0 z-10 shadow-card ring-1 ring-black/[0.02] dark:ring-white/[0.05]">
