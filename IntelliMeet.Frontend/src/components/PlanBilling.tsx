  ...
  return (
    <div className="flex h-[100dvh] max-h-[100dvh] min-h-0 w-full max-w-full im-app-canvas overflow-hidden">
      ...
      <div className="ml-0 md:ml-[270px] flex-1 flex flex-col min-h-0 h-full overflow-hidden relative">
        {/* Topbar */}
        <div className="bg-bg-surface-alpha-90 backdrop-blur-xl border-b border-stroke-primary px-8 py-[13px] flex items-center justify-between shadow-card shrink-0 z-100 ring-1 ring-black/[0.02] dark:ring-white/[0.05]">
          <SearchBar />
        </div>
