  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 1px 0 rgba(6, 27, 22, 0.04), 0 1px 2px rgba(9, 25, 72, 0.06)',
        'lg': '0px 12px 40px 1px rgba(0, 0, 0, 0.06)',
        'float': '0 1px 2px rgba(6, 27, 22, 0.04), 0 8px 24px -6px rgba(6, 27, 22, 0.08)',
        'panel': '0 24px 48px -12px rgba(6, 27, 22, 0.12), 0 8px 16px -8px rgba(6, 27, 22, 0.06)',
      },
      maxWidth: {
        'container': '1440px',
        'content': '1106px',
